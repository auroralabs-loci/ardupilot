...
""")
    ...
    def VibrationRectificationBiasLearning(self):
        ...
        self.set_parameters({
            ...
            "LOG_FILE_DSRMROT": 1,
            # every IMU learns its own bias, so set them all here: the context
            # can only revert parameters the test has touched
            "INS_ACC_VRFB_Z": 0,
            "INS_ACC2_VRFB_Z": 0,
            "INS_ACC3_VRFB_Z": 0,
        })
        ...
        self.wait_ready_to_arm()
        self.takeoff(10, mode='LOITER')
        self.delay_sim_time(30, "hover so the bias can be learned")
        self.land_and_disarm()
        ...
        self.wait_ready_to_arm()
        self.takeoff(10, mode='LOITER')
        self.delay_sim_time(10, "hover before checking the bias persisted")
        self.land_and_disarm()
        vrfb_z = self.get_parameter("INS_ACC_VRFB_Z")
