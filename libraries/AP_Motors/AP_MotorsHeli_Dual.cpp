...
void AP_MotorsHeli_Dual::Log_Write(void)
{
    ...
    _swashplate1.write_log(_collective_min_deg.get(), _collective_max_deg.get(), _collective_min.get(), _collective_max.get());
    _swashplate2.write_log(_collective_min_deg.get(), _collective_max_deg.get(), _collective2_min.get(), _collective2_max.get());
