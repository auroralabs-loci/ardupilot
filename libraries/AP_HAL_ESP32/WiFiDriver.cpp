...
*/
    ...
    hal.console->printf("WiFi softAP init finished. SSID: %.*s password: %s channel: %d\n",
                        (int)sizeof(wifi_config.ap.ssid), wifi_config.ap.ssid, wifi_config.ap.password, wifi_config.ap.channel);
...
*/
    ...
    if (bits & WIFI_CONNECTED_BIT) {
        ESP_LOGI(TAG, "connected to ap SSID: %.*s password: %s",
                 (int)sizeof(wifi_config.sta.ssid), wifi_config.sta.ssid, wifi_config.sta.password);
