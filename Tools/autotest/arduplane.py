...
#            raise NotAchievedException("Expected non-zero runtime for math")
    ...
    def PPPPeriphNoSoftFlow(self):
        ...
        self.set_parameter("NET_TESTS", 32)
    ...
    def PPPPeriph(self):
        ...
        # NET_TESTS is exposed only by the rebuilt frame. Its test-only update
        # hook starts newly enabled tests without requiring another reboot.
        self.set_parameter("NET_TESTS", 32)
